                                          ...
                                          >
                                            ...
                                            >
                                              <tr>
                                                ...
                                                >
                                                  <img
                                                    src="https://middler.com/assets/logo.png"
                                                    class=""
                                                    width="275"
                                                    height="195"
                                                    alt=""
                                                        ...
                                                        <div>
                                                          <span
                                                            style="
                                                              ...
                                                              color: #000000;
                                                            "
                                                            >We received a request to reset your password for your account associated with this email address. If you made this request, you can set a new password by clicking the button below.</span
                                                          >
                                                        </div>
                                                      </td>
                                                    </tr>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                      ...
                                                      <td align="center" valign="top">
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                          <th valign="top" align="center" style="font-weight: normal; line-height: 1; text-align: center;">
                                                          <!--[if mso]>
                                                          <table  border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="border-collapse: separate;margin-right: auto; margin-left: auto;">
                                                              <tr>
                                                                  ...
                                                                  <a href="${url}/reset-password/${token}" class="pc-font-alt" style="display: inline-block;text-decoration: none;white-space: nowrap;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff;" target="_blank">Reset Email</a>
                                                              </td>
                                                              </tr>
                                                          </table>
                                                          <![endif]-->
                                                          <!--[if !mso]><!-- --><a href="${url}/reset-password/${token}" style="width: 100%; border-radius: 8px;background-color: #1D42F3; padding: 14px 19px 14px 19px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff; text-align: center; text-align-last: center; text-decoration: none;display: inline-block; vertical-align: top; white-space: nowrap; -webkit-text-size-adjust: none;" target="_blank">Reset Password</a>
                                                          <!--<![endif]-->
                                                          </th>
                                                        </tr>
                                                        </table>
