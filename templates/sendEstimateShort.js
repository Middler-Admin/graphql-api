exports.sendEstimateShort = (
  ...
  const replyToEmail = businessEmail || 'no-reply@middler.com'; // Fallback to no-reply email

  const message = businessEmail
    ? 'You can reply directly to this email to contact us.'
  ...
  return {
    ...
    ReplyToAddresses: [replyToEmail], // Set the Reply-To field
    Message: {
      Subject: {
          ...
          <table class="pc-project-body" style="table-layout: fixed; min-width: 600px; background-color: #ffffff;" bgcolor="#ffffff" width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
            ...
            <td align="center" valign="top">
                          ...
                          <tr>
                            ...
                            <table class="pc-width-fill pc-w620-gridCollapsed-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              ...
                              <td class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-30" align="center" valign="top" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                                ...
                                <tr>
                                  <td align="center" valign="middle" style="padding: 15px 0px 15px 0px;">
              ...
              : `https://middler.com/assets/templogo.png`
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td class="pc-w620-spacing-0-0-32-0" align="center" valign="top" style="padding: 5px 0px 5px 10px;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                <tr>
                                <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 30px 0px 0px;">
                                  <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; font-variant-ligatures: normal; color: #2d2d2f; text-align: center; text-align-last: center;">
                                  <div><span>Your estimate includes all labor, materials and paint.</span>
                                  </div>
                                  </div>
                                </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                    ...
                                    <td align="left" valign="top">
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                          <!-- Painting Estimates Title -->
                                          <td align="left" style="padding: 10px;">
                                            <div class="pc-font-alt" style="line-height: 140%; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 22px; font-weight: bold; color: #333333;">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td class="pc-w620-spacing-0-0-32-0" align="center" valign="top" style="padding: 30px 0px 4px 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                              <tr>
                          ...
                          <tr>
                            <td class="pc-w620-spacing-0-0-32-0" align="center" valign="top" style="padding: 10px 0px 48px 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                              <tr>
                              <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 30px 0px 0px;">
                                      ...
                                      <tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="center" style="border-collapse: separate; border-spacing: 0;">
                                          ...
                                          <td valign="top" class="pc-w620-padding-0-50-0-50" align="center">
                                            <div class="pc-font-alt pc-w620-lineHeight-120pc" style="line-height: 140%; letter-spacing: -0px; font-family: 'Montserrat', Arial, Helvetica, sans-serif; font-size: 32px; font-weight: bold; font-variant-ligatures: normal; color: #030303; text-align: center; text-align-last: center;">
                                      ...
                                      <tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="center" style="border-collapse: separate; border-spacing: 0;">
                                          ...
                                          <td valign="top" class="pc-w620-padding-0-50-0-50" align="center">
                                            ...
                                            <div><span style="color: #030303;">Your painter is providing you an estimate that is middler certified.</span>
                                            </div>
                                            </div>
                                          </td>
                                          </tr>
