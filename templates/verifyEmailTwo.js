exports.verifyEmailTwo = (email, name, url, token, clientId) => {
  return {
              ...
              <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width: 100%;">
                        ...
                        <td valign="top" class="pc-w520-padding-30-40-30-40 pc-w620-padding-35-50-35-50" style="padding: 40px 60px 40px 60px;border-radius: 0px;background-color: #ffffff;" bgcolor="#ffffff">
                          ...
                          <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="margin-right: auto; margin-left: auto;">
                              <tr>
                              <td valign="top" class="pc-font-alt pc-w620-fontSize-30 pc-w620-lineHeight-40" align="center" style="mso-line-height: exactly;line-height: 128%;letter-spacing: -0.6px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 36px;font-weight: 800;color: #151515;text-align: center;text-align-last: center;">
                                <div><span>Email Verification</span>
                                </div>
                              </td>
                              </tr>
                            </table>
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td align="center" valign="top" style="padding: 0px 0px 100px 0px;">
                            <img src="http://52.90.254.174/assets/logo.png" class="" width="275" height="195" alt="" style="display: block;border: 0;outline: 0;line-height: 20%;-ms-interpolation-mode: bicubic;width:275px;height: auto;max-width: 20%;" />
                            </td>
                          </tr>
                          </table>
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="margin-right: auto; margin-left: auto;">
                              <tr>
                              <td valign="top" class="pc-font-alt" align="center" style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 18px;font-weight: normal;color: #9b9b9b;text-align: center;text-align-last: center;">
                                <div><span style="font-weight: normal;font-style: normal;color: #000000;">Hello, ${name}</span>
                                </div>
                                <div><span>&#xFEFF;</span>
                                </div>
                                <div><span style="font-weight: normal;font-style: normal; color: #000000;">You must authorize this email address for use with Middler. If you've requested a painting estimate, please click on following button to confirm that you are authorized to use this email address. Once the email is authorized you will have access to your first painting estimate.</span>
                                </div>
                              </td>
                              </tr>
                            </table>
                  ...
                  <table  border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="border-collapse: separate;margin-right: auto; margin-left: auto;">
                      <tr>
                          <td valign="middle" align="center" style="text-align: center; color: #ffffff;border-radius: 8px;background-color: #3E8BCC; padding: 14px 19px 14px 19px;" bgcolor="#fc0031">
                                              <a href="${url}/verification/${token}?estimate=${clientId}" class="pc-font-alt" style="display: inline-block;text-decoration: none;white-space: nowrap;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff;" target="_blank">Confirm Email</a>
                                          </td>
                      </tr>
                  </table>
                  <![endif]-->
                                        <!--[if !mso]><!-- --><a href="${url}/verification/${token}?estimate=${clientId}" style="border-radius: 8px;background-color: #1D42F3;padding: 14px 19px 14px 19px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff;text-align: center;text-align-last: center;text-decoration: none;display: inline-block;vertical-align: top;white-space: nowrap;-webkit-text-size-adjust: none;" target="_blank">Confirm Email</a>
                                        <!--<![endif]-->
                                        </th>
                                      </tr>
                                      </table>
