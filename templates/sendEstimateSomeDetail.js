exports.sendEstimateSomeDetail = (
  clientURL,
  email,
  businessLogo,
  businessName,
          ...
          <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <table class="pc-project-body" style="table-layout: fixed; min-width: 600px; background-color: #ffffff;" bgcolor="#ffffff" width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                    ...
                    <td valign="top">
                      ...
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation" style="border-collapse: separate; border-spacing: 0px;">
                          <tr>
                          <!--[if !gte mso 9]><!-- -->
                          <td valign="top" class="pc-w620-padding-0-0-0-0" style="background-size: cover; background-position: center; background-repeat: no-repeat; padding: 0px 0px 0px 0px; border-radius: 23px 23px 0px 0px; background-color: #f8f9fd;" bgcolor="#f8f9fd" background="${clientURL}/assets/emaiilheaderbackground.png">
                            <!--<![endif]-->
                            <!--[if gte mso 9]>
                            <td valign="top" align="center" style="background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #f8f9fd; border-radius: 23px 23px 0px 0px;" bgcolor="#f8f9fd" background="${clientURL}/assets/emaiilheaderbackground.png">
                        <![endif]-->
                            <!--[if gte mso 9]>
                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
                                <v:fill src="${clientURL}/assets/emaiilheaderbackground.png" color="#f8f9fd" type="frame" size="1,1" aspect="atleast" origin="0,0" position="0,0"/>
                            ...
                            <tr>
                              ...
                              <table class="pc-width-fill pc-w620-gridCollapsed-0" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <td class="pc-grid-td-first pc-grid-td-last" align="center" valign="top" style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                                  ...
                                  <tr>
                                    <td class="pc-w620-padding-32-24-32-24" align="center" valign="middle" style="padding: 30px 32px 30px 32px; mso-padding-left-alt: 0; margin-left:32px;">
                                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                      ...
                                      <td align="center" valign="top">
                                        ...
                                        <tr>
                                          ...
                                          <img src="${clientURL}/assets/logo-white.png" class="pc-w620-width-80 pc-w620-height-auto" width="60" height="60" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:60px; height:60px; border: 0;" />
                                          </td>
                                        </tr>
                                        </table>
                                      </td>
                                      ...
                                      <td align="center" valign="top">
                                        ...
                                        <tr>
                                          <td class="pc-w620-spacing-0-0-16-0" valign="top" style="padding: 0px 0px 10px 0px;">
                                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0;">
                                            <tr>
                                            <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 40px 0px 40px; mso-padding-left-alt: 0; margin-left:40px;">
                                              <div class="pc-font-alt pc-w620-fontSize-32px pc-w620-lineHeight-120pc" style="line-height: 140%; letter-spacing: 0px; font-family: 'Montserrat', Arial, Helvetica, sans-serif; font-size: 32px; font-weight: bold; font-variant-ligatures: normal; color: #ffffff; text-transform: uppercase; text-align: center; text-align-last: center;">
                                              <div><span style="color: rgb(255, 255, 255);">Your Middler certified painting estimate!</span>
                                              </div>
                                              </div>
                                            </td>
                                            </tr>
                                        ...
                                        <tr>
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0;">
                                            ...
                                            <td valign="top" class="pc-w620-padding-0-0-0-0" align="center">
                                              <div class="pc-font-alt pc-w620-fontSize-14px pc-w620-lineHeight-140pc" style="line-height: 24px; letter-spacing: -0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; font-variant-ligatures: normal; color: #ffffff; text-align: center; text-align-last: center;">
                                              <div><span>Middler a symbol of quality and reliability, middler certified estimates provide assurances that prices are as accurate as possible.</span>
                                              </div>
                                              </div>
                                            </td>
                                            </tr>
                            ...
                            <tr>
                              ...
                              <table class="pc-width-fill pc-w620-gridCollapsed-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <td class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-30" align="center" valign="top" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                                  ...
                                  <tr>
                                    <td align="center" valign="middle" style="padding: 30px 0px 30px 0px;">
                                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                      <tr>
                                      <td align="center" valign="top">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                          ...
                                          <table class="pc-width-fill pc-w620-gridCollapsed-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr class="pc-grid-tr-first pc-grid-tr-last">
                                            <td class="pc-grid-td-first pc-w620-itemsSpacings-0-30" align="center" valign="middle" style="width: 50%; padding-top: 0px; padding-right: 20px; padding-bottom: 0px; padding-left: 0px;">
                                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate; border-spacing: 0;">
                                              <tr>
                                                <td align="center" valign="middle" style="padding: 0px 40px 0px 40px;">
                                                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                                  <tr>
                                                  <td align="center" valign="top">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
              ...
              : `${clientURL}/assets/templogoclient.png`
                                            ...
                                            <td class="pc-grid-td-last pc-w620-itemsSpacings-0-30" align="center" valign="middle" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 20px;">
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate; border-spacing: 0; width: 100%;">
                                              <tr>
                                                ...
                                                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                                  ...
                                                  <td align="center" valign="top">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: center; text-align-last: center;">
                                                        <div><span style="text-transform: uppercase;font-weight: 700;font-style: normal;">${businessName}</span>
                                                        </div>
                                                        <div><span>${businessAddress}</span>
                                                        </div>
                                                        <div><span>License: ${businessLicenseNumber}</span>
                                                        </div>
                                                        <div><span>${businessEmail}</span>
                                                        </div>
                                                        <div><span>${businessPhone}</span>
                                                        </div>
                                                      </div>
                                                      </td>
                                                    </tr>
                                      ...
                                      <td align="left" valign="top">
                                        ...
                                        <tr>
                                          ...
                                          <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 22px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                                            <div><span style="font-weight: 700;font-style: normal;">Paint Estimates</span>
                                            </div>
                                          </div>
                                          </td>
                                        </tr>
                                      ...
                                      <td align="left" valign="top">
                                        ...
                                        <tr>
                                          ...
                                          <table class="pc-width-fill pc-w620-tableCollapsed-0" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr align="center" valign="middle">
                                              <td align="center" valign="middle" style="padding: 10px 10px 10px 10px; border-bottom: 1px solid #656e81;">
                                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                <tr>
                                                <td valign="top" align="center">
                                              ...
                                              <td width="121" valign="middle" style="border-bottom: 1px solid #656e81;">
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                              ...
                                              <td width="126" valign="middle" style="border-bottom: 1px solid #656e81;">
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                              ...
                                              <td width="172" valign="middle" style="border-bottom: 1px solid #656e81;">
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                            ...
                                            <tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="left">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="left">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                                                      <div><span style="font-weight: 700;font-style: normal;">${clientName}</span>
                                                      </div>
                                                      <div><span>${clientPhone}</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                <td style="padding: 10px 10px 10px 10px;" align="right">
                                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                  <tr>
                                                    <td valign="top" align="right">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: right; text-align-last: right;">
                                                      <div><span>${clientAddress}</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                            ...
                            <tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                <tr>
                                <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 30px 0px 0px;">
                                  ...
                                  <div><span>We would like to thank you for the opportunity to provide you with our estimate for your project and hope that we will be able to complete it for you to our highest standards. Please find enclosed the detailed summary of the job and our estimate. If you have any questions please do not hesitate to contact us. Again we sincerely appreciate the opportunity to estimate your project and look forward to working together.</span>
                                  </div>
                                  </div>
                                </td>
                                </tr>
                            ...
                            <tr>
                              ...
                              <table class="pc-width-fill pc-w620-tableCollapsed-0" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; width: 100%;">
                                <tbody>
                                <tr bgcolor="#5c6ef0" style="background-color: #5c6ef0;">
                                  <td align="left" valign="top" style="padding: 10px 10px 10px 10px;">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                    <tr>
                                    <td valign="top" align="left">
                                      <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: bold; font-variant-ligatures: normal; color: #ffffff; text-align: left; text-align-last: left;">
                                      <div><span style="font-weight: 700;font-style: normal;color: #ffffff;">Notes and Disclosure</span>
                                      </div>
                                      </div>
                                    </td>
                                    </tr>
                                ...
                                <tr bgcolor="transparent" style="background-color: transparent;">
                                  <td align="left" valign="top" style="padding: 10px 10px 50px 10px;">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                    <tr>
                                    <td valign="top" align="left">
                                      <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #000000; text-align: left; text-align-last: left;">
                                      <div><span style="font-weight: 400;font-style: normal;color: #000000;">${notesAndDisclosures}</span>
                                      </div>
                                      </div>
                                    </td>
                                    </tr>
                            ...
                            <tr>
                              ...
                              <table class="pc-width-fill pc-w620-gridCollapsed-0" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <td class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-30" align="left" valign="top" style="width: 100%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate; border-spacing: 0; width: 100%;">
                                  <tr>
                                    <td align="left" valign="top" style="padding: 10px 10px 10px 10px; background-color: #5c6ef0; border-bottom: 1px solid #ffffff;">
                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                      <tr>
                                      <td align="left" valign="top">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left" style="border-collapse: separate; border-spacing: 0;">
                                        <tr>
                                          <td valign="top" align="left">
                                          <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: bold; font-variant-ligatures: normal; color: #ffffff; text-align: left; text-align-last: left;">
                                            <div><span style="font-weight: 700;font-style: normal;color: #ffffff;">Interior Info</span>
                                            </div>
                                          </div>
                                          </td>
                                        </tr>
                                ...
                                <td class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-30" align="left" valign="top" style="width: 100%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                                  ...
                                  <tr>
                                    <td align="left" valign="top" style="background-color: #5c6ef0;">
                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                      <tr>
                                      <td align="left" valign="top">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                          <td>
                                          <table class="pc-width-fill pc-w620-tableCollapsed-0" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" bgcolor="#f8f9fd" style="border-collapse: separate; border-spacing: 0; width: 100%; background-color:#f8f9fd; border-right: 1px dashed #417CD6; border-bottom: 1px dashed #417CD6; border-left: 1px dashed #417CD6;">
                                            <tbody>
                                            <tr align="center" valign="top">
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #040404; text-align: center; text-align-last: center;">
                                                      <div><span style="color: #040404;">Interior Squarefeet</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #000000; text-align: center; text-align-last: center;">
                                                      <div><span style="color: #000000;">${interiorSquareFeet}</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #040404; text-align: center; text-align-last: center;">
                                                      <div><span style="color: rgb(4, 4, 4);">Doors and Drawers</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #000000; text-align: center; text-align-last: center;">
                                                      <div><span style="color: #000000;">${doorsAndDrawers}</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                            ...
                                            <tr align="center" valign="top">
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #010101; text-align: center; text-align-last: center;">
                                                      <div><span style="color: #010101;">Interior Items</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                                                ...
                                                                >
                                                                  <tr>
                                                                    ...
                                                                    >
                                                                      <div
                                                                        class="pc-font-alt"
                                                                        style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #0c0c0c; text-align: center; text-align-last: center;"
                                                                      >
                                                                        <div>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #010101; text-align: center; text-align-last: center;">
                                                      <div><span style="color: rgb(1, 1, 1);">Interior Individual Items</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                    ...
                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                      ...
                                      <td align="left" valign="top">
                                        ...
                                        <tr>
                                          <td valign="top" align="left">
                                          <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: bold; font-variant-ligatures: normal; color: #ffffff; text-align: left; text-align-last: left;">
                                            <div><span style="font-weight: 700;font-style: normal;color: rgb(255, 255, 255);">Exterior Info</span>
                                            </div>
                                          </div>
                                          </td>
                                        </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #040404; text-align: center; text-align-last: center;">
                                                      <div><span style="color: rgb(4, 4, 4);">Exterior Squarefeet</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #000000; text-align: center; text-align-last: center;">
                                                      <div><span style="color: #000000;">${exteriorSquareFeet}</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #010101; text-align: center; text-align-last: center;">
                                                      <div><span style="color: rgb(1, 1, 1);">Exterior Items</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                              ...
                                              <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <td style="padding: 10px 10px 10px 10px;" align="center">
                                                  ...
                                                  <tr>
                                                    <td valign="top" align="center">
                                                    <div class="pc-font-alt" style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #010101; text-align: center; text-align-last: center;">
                                                      <div><span style="color: rgb(1, 1, 1);">Exterior Individual Items</span>
                                                      </div>
                                                    </div>
                                                    </td>
                                                  </tr>
                                        ...
                                        <tr>
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="center" style="border-collapse: separate; border-spacing: 0;">
                                            ...
                                            <td valign="top" class="pc-w620-padding-0-50-0-50" align="center">
                                              <div class="pc-font-alt pc-w620-lineHeight-120pc" style="line-height: 140%; letter-spacing: -0px; font-family: 'Montserrat', Arial, Helvetica, sans-serif; font-size: 32px; font-weight: bold; font-variant-ligatures: normal; color: #030303; text-transform: uppercase; text-align: center; text-align-last: center;">
                                              <div><span style="color: #030303;">Questions or concers?</span>
                                              </div>
                                              </div>
                                            </td>
                                            </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                        <tr>
                            <td valign="middle" align="center" style="border-radius: 8px; background-color: #5c6ef0; text-align:center; color: #ffffff; padding: 14px 19px 14px 19px; mso-padding-left-alt: 0; margin-left:19px;" bgcolor="#5c6ef0">
                                                <a class="pc-font-alt" style="display: inline-block; text-decoration: none; font-variant-ligatures: normal; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 500; font-size: 16px; line-height: 24px; letter-spacing: -0.2px; text-align: center; color: #ffffff;" href="https://designmodo.com/postcards" target="_blank"><span style="display: block;"><span>Message Us</span></span></a>
                                            </td>
                        </tr>
                    </table>
                    <![endif]-->
                                          <!--[if !mso]><!-- -->
                                          <a style="display: inline-block; box-sizing: border-box; border-radius: 8px; background-color: #5c6ef0; padding: 14px 19px 14px 19px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 500; font-size: 16px; line-height: 24px; letter-spacing: -0.2px; color: #ffffff; vertical-align: top; text-align: center; text-align-last: center; text-decoration: none; -webkit-text-size-adjust: none;" href="https://designmodo.com/postcards" target="_blank"><span style="display: block;"><span>Message Us</span></span></a>
                                          <!--<![endif]-->
                                          </th>
                                        </tr>
                                        </table>
                        ...
                        <![endif]-->
                            ...
                            <tr>
                              ...
                              <table class="pc-width-fill pc-w620-gridCollapsed-1 pc-w620-halign-center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                <tr class="pc-grid-tr-first pc-grid-tr-last">
                                <td class="pc-grid-td-first pc-w620-itemsSpacings-0-24" align="left" valign="middle" style="width: 50%; padding-top: 0px; padding-right: 20px; padding-bottom: 0px; padding-left: 0px;">
                                ...
                                <td class="pc-grid-td-last pc-w620-itemsSpacings-0-24" align="left" valign="middle" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 20px; mso-padding-left-alt: 0; margin-left: 20px;">
                                        ...
                                        <tr>
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0;">
                                            ...
                                            <td valign="top" align="center">
                                              ...
                                              <div><span style="font-weight: 400;font-style: normal;color: rgb(45, 45, 47);">Interested in changing the emails you get from us? Update your preferences </span><a href="https://designmodo.com/postcards" target="_blank" style="text-decoration: none; color: #2d2d2f;"><span style="text-decoration: underline;font-weight: 400;font-style: normal;color: rgb(45, 45, 47);">here</span></a><span style="font-weight: 400;font-style: normal;color: rgb(45, 45, 47);"> or unsubscribe </span><a href="https://designmodo.com/postcards" target="_blank" style="text-decoration: none; color: #2d2d2f;"><span style="text-decoration: underline;font-weight: 400;font-style: normal;color: rgb(45, 45, 47);">here</span></a><span style="font-weight: 400;font-style: normal;color: rgb(45, 45, 47);">. Our privacy policy is available </span><a href="https://designmodo.com/postcards" target="_blank" style="text-decoration: none; color: #2d2d2f;"><span style="text-decoration: underline;font-weight: 400;font-style: normal;color: rgb(45, 45, 47);">here</span></a><span style="font-weight: 400;font-style: normal;color: rgb(45, 45, 47);">.</span>
                                              </div>
                                              </div>
                                            </td>
                                            </tr>
